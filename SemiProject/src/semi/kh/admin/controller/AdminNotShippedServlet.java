...
/**
 * Servlet implementation class AdminNotShippedServlet
 */
@WebServlet("/admin/notShipped")
public class AdminNotShippedServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		//System.out.println("[NotShippedList sevlet In!!!!! ]\n");
		//인코딩처리
		request.setCharacterEncoding("utf-8");
		
		//업무로직
		List<Buy> list = new ArrayList();
		list = new AdminService().selectNotShippedList();
