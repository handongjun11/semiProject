 ...
 * Generated at: 2019-01-16 10:12:50 UTC
...
public final class noneOrderViewEnd_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(memberLoggedIn != null && ("admin").equals(memberLoggedIn.getMemberId())){ 
      ...
      out.write("    <table id=\"tbl-qna\" style =\"border-collapse: collapse;\" class=\"table\" style='width:800px; background-color:white; margin:0 auto;'> \r\n");
      out.write("      <tr>\r\n");
...
if(b.getShipStatus().equals("배송완료")) { 
      out.write("\r\n");
      out.write("\t\t <input type=\"submit\" class=\"btn\" id=\"btn-review\" style=\"background-color:white;\" value=\"후기작성\" />\r\n");
      out.write("\t\t ");
} 
		 	  else{ 
      out.write("\r\n");
...
if(b.getbLockFlag().equals("Y")){ 
      out.write("\r\n");
      out.write("\t\t\t <td style=\"vertical-align:middle; text-align:left;\" onclick=\"check('");
      out.print(b.getBoardNo());
      ...
      out.write("     <br><br>\r\n");
      out.write("     <!-- ------------------------------------------------------------------------------------- -->\r\n");
      out.write("     <h3>후기 내역</h3>\r\n");
      out.write("     <table id=\"tab-review\" class=\"table table-striped\" style=\"width:800px; background-color:white; margin:0 auto; text-align:center; border-collapse: collapse; \"> \r\n");
      out.write("      <tr>\r\n");
      out.write("         <th style=\"width : 100px; text-align:center;\">첨부파일</th>\r\n");
      out.write("         <th style=\"width : 200px; text-align:center;\">작성내용</th>\r\n");
      out.write("         <th style=\"width : 80px; text-align:center;\">작성일</th>\r\n");
      out.write("         <th style=\"width : 80px; text-align:center;\">평점</th>\r\n");
      out.write("         <th style=\"width : 100px; text-align:center;\"></th>\r\n");
      out.write("      </tr>\r\n");
      out.write("\r\n");
      out.write("\t\t");
 if(rlist == null || rlist.isEmpty()) { 
      out.write("\r\n");
      out.write("            <tr>\r\n");
      out.write("               <td colspan=\"3\" align=\"center\">검색결과가 없습니다.</td>\r\n");
      out.write("            </tr>\r\n");
      out.write("         ");
} else { 
...
if(br.getRfile() == null || br.getRfile().equals("null")){ 
      ...
      out.write("' style=\"width : 10em; height:10em;\"></td>\r\n");
      out.write("\t\t\t");
} 
      out.write("\r\n");
      out.write("\t\t\t\t<td>");
...
for(int i=1 ; i <= (5-br.getRate()) ; i++) {
      ...
      out.write("\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t<form>\r\n");
      out.write("\t\t\t\t<input type=\"button\" value=\"수정\" class=\"btn btn-default\" onclick=\"modify(");
      out.print(br.getbNo() );
      out.write(");\">\r\n");
      out.write("\t\t\t\t<input type=\"button\" value=\"삭제\" class=\"btn btn-primary\" onclick=\"return del(");
      out.print(br.getbNo() );
      out.write(");\">\r\n");
      out.write("\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t</td>\r\n");
 ...
 if(rlist == null || rlist.isEmpty()) { 
      ...
      out.write(" \t\t\t\t<form id=\"");
      out.print(br.getbNo() );
      out.write("\" name=\"deleteFrm\" action=\"");
      out.print(request.getContextPath());
      out.write("/review/deleteReview\">\r\n");
      ...
      out.write("\" >\r\n");
      out.write(" \t\t\t\t<input  type=\"hidden\" name=\"NM\" value=\"비회원\">\r\n");
      out.write(" \t\t\t\t</form>\r\n");
      out.write(" \t\t\t\t\t");
} 
          }
      ...
      out.write("\tlocation.href = \"");
      out.print(request.getContextPath());
      out.write("/board/shipQnaBoardForm?orderNo=\"+orderNo+\"&password=\"+");
      out.print(password);
      out.write(";\r\n");
      out.write("});\r\n");
      out.write("$(\"#btn-review\").on(\"click\", function(){\r\n");
      out.write("\t\r\n");
      out.write("\t//비회원 후기작성  폼으로 옮기기 !!!!!!!!! url주소 바꾸기 !!!\r\n");
      out.write("\t location.href = \"");
      out.print(request.getContextPath());
      out.write("/board/reviewForm\" ;\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("\t\r\n");
      out.write("});\r\n");
      out.write("\r\n");
      out.write("function modify(boardno){\r\n");
      out.write("\t\r\n");
      out.write("\tlocation.href=\"");
      out.print(request.getContextPath());
      out.write("/review/modify?boardno=\"+boardno+\"&password=\"+");
      out.print(password);
      out.write(" ;\r\n");
      out.write("\t\r\n");
      out.write("}\r\n");
      out.write("function del(boardno){\r\n");
      out.write("\t\r\n");
      out.write("\tif(!confirm(\"이 게시글을 정말 삭제하시겠습니까?\")){\r\n");
      out.write("\t\treturn;\r\n");
      out.write("\t}\r\n");
      out.write("\t\r\n");
      out.write("\t$(\"#\"+boardno).submit();\r\n");
      out.write("\t\r\n");
      out.write("}\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
