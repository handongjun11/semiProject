 ...
 * Generated at: 2019-01-18 12:10:12 UTC
...
public final class productList_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("oracle.jdbc.diagnostics.DemultiplexingLogHandler");
  }
...
if(memberLoggedIn != null && ("admin").equals(memberLoggedIn.getMemberId())){ 
	...
	//System.out.println(request.getContextPath()); // '/hdj'
      ...
      out.write("<script>\r\n");
      out.write("\r\n");
      out.write("function selectPrdView(pId){\r\n");
      out.write("\tlocation.href = \"");
      out.print(request.getContextPath());
      out.write("/product/productView?pId=\"+pId;\r\n");
      out.write("}\r\n");
      out.write("\r\n");
      out.write("//마우스 클릭 이벤트에 따라 추가/삭제 : 새로 생성된 요소에 대하여 이벤트 핸들러 추가\r\n");
      out.write("$(function(){\r\n");
      out.write("\t$(\".type_thumb\").on(\"click\",function(){\t\r\n");
      out.write("\t\t$(\".prdInfo-wrap>div\").attr('class','prdInfo_thumb')\r\n");
      out.write("\t\t\t\t\t\t\t  .css({\"width\" : \"30%\",\r\n");
      out.write("\t\t\t\t\t \t   \t\t\t\"transition\" : \"box-shadow .2s ease\"});\r\n");
      out.write("\r\n");
      out.write("\t});\r\n");
      out.write("\r\n");
      out.write("\t$(\".type_list\").on(\"click\",function(){\t\r\n");
      out.write("\t\t$(\".prdInfo-wrap>div\").attr('class','prdInfo_list').css({\"width\" : \"100%\"});\r\n");
      out.write("\t}); \t\r\n");
      out.write("\r\n");
      out.write("});\r\n");
      out.write("</script>\r\n");
      out.write("\r\n");
      out.write("<section id=\"productList-container\">\r\n");
      out.write("\t<div class=\"banner\">\r\n");
      out.write("\t\t<img src=\"");
      out.print(request.getContextPath() );
      out.write("/images/banner/PC_images.webp\" style=\"width: 940px;\" />\r\n");
      out.write("\t</div>\r\n");
      out.write("\t<ul id=\"sort_type\">\r\n");
      out.write("\t\t<li class=\"type_list\"><i class=\"fas fa-align-justify\" style=\"font-size:30px;\"></i></li>\r\n");
      out.write("\t\t<li class=\"type_thumb\"><i class=\"fas fa-th\" style=\"font-size:30px;\"></i></li>\t\t \r\n");
      out.write("\t\t<li>");
      out.print(pList.get(0).getpCategory());
      out.write("&nbsp;>&nbsp;");
      out.print(pList.get(0).getDescription());
      out.write("</li>\t\t \r\n");
      out.write("\t</ul>\r\n");
      out.write("\t\r\n");
      out.write("\t<div class = \"prdInfo-wrap\" >\r\n");
      out.write("\t\t");
 for(Product p : pList){ 
			String price = new DecimalFormat().format(p.getpPrice());	
		
      out.write("\r\n");
      out.write("\t\t\t<div class=\"prdInfo_list\" >\t\r\n");
      ...
      out.print(request.getContextPath());
      out.write("/images/error_thumb.jpg'\" \r\n");
      out.write("\t\t\t\t  \t\t onclick = 'selectPrdView(\"");
      out.print(p.getpId());
      out.write("\");'/>\r\n");
      out.write("\t    \t\t</div>\r\n");
      out.write("\t    \t\t\r\n");
      out.write("\t\t\t  \t<div class=\"prdTxt\" onclick = 'selectPrdView(\"");
      out.print(p.getpId());
      out.write("\");'>\r\n");
      out.write("\t\t\t  \t\t<p class=\"pName\" style=\"font-weight: bold;\">");
      out.print(p.getpName() );
      out.write("</p>\r\n");
      ...
      out.write("\t\t\t  \t</div>\r\n");
      out.write("\t\t\t  \t\r\n");
      out.write("\t\t\t  \t<div class=\"prdPrice\" style=\"margin-top: 6px;\" onclick = 'selectPrdView(\"");
      out.print(p.getpId());
      out.write("\");'>\r\n");
      out.write("\t\t\t  \t\t<p class=\"priceTit\">판매가&nbsp;&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t\t  \t\t\t<strong style=\"font-size:20px\">");
      out.print(price );
      out.write("</strong><em>원</em></p>\r\n");
      out.write("\t\t\t\t\t<p class=\"priceTit\" style=\"color:red;\">최대혜택가\r\n");
      out.write("\t\t\t\t\t\t<strong style=\"font-size:20px\">");
      out.print(price );
      out.write("</strong><em>원</em></p>\r\n");
      out.write("\t\t\t  \t</div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t  \t<div class=\"score\" onclick = 'selectPrdView(\"");
      out.print(p.getpId());
      out.write("\");'>\r\n");
      out.write("\t\t\t\t\t<div class=\"star\" >\r\n");
      out.write("\t\t\t\t\t\t<span class =\"star_rating\" style=\"display:inline; \">\r\n");
      out.write("\t\t\t\t\t\t\t<div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<img src=\"");
      out.print(request.getContextPath());
      out.write("/images/graystar.PNG\" onclick = 'selectPrdView(\"");
      out.print(p.getpId());
      out.write("\");'>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
if(p.getSumrate() == 6){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<img  style=\"margin-top: -40px; margin-left: -180px;\"  src=\"");
      out.print(request.getContextPath());
      out.write("/images/star.png\" onclick = 'selectPrdView(\"");
      out.print(p.getpId());
      out.write("\");'/>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
}else if(p.getSumrate() == 1){ 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<img  style=\"margin-top: -40px; margin-left: -147px;\"  src=\"");
      out.print(request.getContextPath());
      out.write("/images/star.png\" onclick = 'selectPrdView(\"");
      out.print(p.getpId());
      out.write("\");'/>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<img  style=\"margin-top: -40px; margin-left: -110px;\"  src=\"");
      out.print(request.getContextPath());
      out.write("/images/star.png\" onclick = 'selectPrdView(\"");
      out.print(p.getpId());
      out.write("\");'/>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<img  style=\"margin-top: -40px; margin-left: -73px;\"  src=\"");
      out.print(request.getContextPath());
      out.write("/images/star.png\" onclick = 'selectPrdView(\"");
      out.print(p.getpId());
      out.write("\");'/>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<img  style=\"margin-top: -40px; margin-left: -36px;\"  src=\"");
      out.print(request.getContextPath());
      out.write("/images/star.png\" onclick = 'selectPrdView(\"");
      out.print(p.getpId());
      out.write("\");'/>\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t<img  style=\"margin-top: -40px; \"  src=\"");
      out.print(request.getContextPath());
      out.write("/images/star.png\" onclick = 'selectPrdView(\"");
      out.print(p.getpId());
      out.write("\");'/>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</span>\r\n");
      out.write("\t\t\t\t\t<div style=\"padding: 0 0 0 22px;\">(상품평 ");
      out.print(p.getCnt() );
      out.write("<em>건</em>)</div>\t\t\t\t\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t    </div>\r\n");
      out.write("\r\n");
      out.write("\t\t\t</div> <!-- proInfo -->\r\n");
      out.write("\t\t");
 } 
