 ...
 * Generated at: 2019-01-16 10:23:50 UTC
...
session.setAttribute("sc", null);
      ...
      out.write("\r\n");
      out.write("\r\n");
      out.write("<div id=\"container\" style=\"width:940px;\">\r\n");
      out.write("\r\n");
      out.write("\t<section id=\"tbl-container\">\r\n");
      out.write("\t<br />\r\n");
      out.write("\t<h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;장바구니</h2>\r\n");
      out.write("\t<br />\r\n");
      out.write("\t<table id=\"product\" class=\"table table-striped\" style=\"width:800px; background-color:white; margin:0 auto;\">\r\n");
      out.write("\t\t<thead>\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<th style=\"width:80px; vertical-align:middle; text-align:center;\">사진</th>\r\n");
      out.write("\t\t\t\t<th style=\"width:170px; vertical-align:middle; text-align:center;\">상품아이디</th>\r\n");
      out.write("\t\t\t\t<th style=\"width:170px; vertical-align:middle; text-align:center;\">상품명</th>\r\n");
      out.write("\t\t\t\t<th style=\"width:100px; vertical-align:middle; \"></th>\r\n");
      out.write("\t\t\t\t<th style=\"width:100px; vertical-align:middle; text-align:center;\">수량</th>\r\n");
      out.write("\t\t\t\t<th style=\"width:100px; vertical-align:middle; text-align:center;\">상품가격</th>\r\n");
      out.write("\t\t\t\t<th><button class=\"btn btn-default btn-sm\" id=\"allDelete\">전체삭제</button></th>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t</thead>\r\n");
      out.write("\t\t<tbody>\r\n");
      out.write("\t\t");
      ...
      out.write("_thumb1.png\" style=\"width:70px\"/></td>\r\n");
      ...
      out.print( new DecimalFormat().format(c.getpPrice()) + "원");
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td style=\"vertical-align:middle; text-align:center;\"><input type=\"number\" class=\"changeAmount form-control\" min=1 value=\"");
      out.print(c.getAmount() );
      out.write("\" placeholder=");
      out.print(c.getAmount() );
      out.write(" /><input type=\"hidden\" id=\"changePId\" value=");
      out.print(c.getpId());
      out.write(" /> <input type=\"hidden\" id=\"changePrice\" value=");
      out.print(c.getpPrice() );
      out.write(" /></td>\r\n");
      out.write("\t\t\t\t<td style=\"vertical-align:middle; text-align:center;\">");
      out.print(new DecimalFormat().format(c.getpPrice() * c.getAmount())  +"원" );
      out.write("</td>\r\n");
      out.write("\t\t\t\t<td style=\"vertical-align:middle; text-align:center;\"><button class=\"deleteItem btn btn-default\" value=");
      out.print(c.getpId() );
      ...
      out.write("\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td colspan=\"5\" style=\"vertical-align:middle; text-align:right; height:78px;\" ><h3>총가격</h3></td>\r\n");
      out.write("\t\t\t\t<td colspan=\"2\" style=\"vertical-align:middle; text-align:center;\"><h3 id=\"tp\" value=\"");
      ...
      out.write("\r\n");
      out.write("\t\t\t<tr>\r\n");
      out.write("\t\t\t\t<td colspan=\"7\" style=\"text-align:center;\">장바구니에 담은 상품이 없습니다.</td>\r\n");
      out.write("\t\t\t</tr>\r\n");
      out.write("\t\t");
      ...
      out.write("\t<br />\r\n");
      out.write("\r\n");
      out.write("\t<form style=\"text-align:center;\" action=\"");
      out.print(request.getContextPath());
      out.write("/product/productBuy\">\r\n");
      out.write("\t\t<input type=\"hidden\" name=\"cartList\" value=");
      out.print(list );
      out.write("/>\r\n");
      out.write("\t\t&nbsp;&nbsp;&nbsp;\r\n");
      out.write("\t\t");
 if(!list.isEmpty()){ 
      out.write("\r\n");
      out.write("\t\t\t<button type=\"submit\" class=\"btn btn-lg btn-primary\">상품주문</button>\r\n");
      out.write("\t\t");
} 
      out.write("\t\r\n");
      out.write("\t</form>\r\n");
      ...
      out.write("\r\n");
      out.write("<script>\r\n");
      out.write("$(\".deleteItem\").on(\"click\", function(){\r\n");
      ...
      out.write("\t\turl : \"");
      out.print(request.getContextPath());
      out.write("/product/productDeleteItem.do\",\r\n");
      out.write("\t\tdata : \"pId=\"+pId,\r\n");
      out.write("\t\tsuccess : function(data){\r\n");
      out.write("\t\t\tlocation.href=\"");
      out.print(request.getContextPath());
      out.write("/product/productCart\";\r\n");
      out.write("\t\t}\r\n");
      out.write("\t})\r\n");
      out.write("});\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("var oldAmount = \"\";\r\n");
      out.write("$(\".changeAmount\").on(\"mousedown\", function(){\r\n");
      out.write("\toldAmount = $(this).val();\r\n");
      out.write("}).on(\"mouseup\", function(event){\r\n");
      out.write("\tvar pId = $(this).next().val();\r\n");
      out.write("\tvar amount = $(this).val();\r\n");
      out.write("\tvar price = $(this).next().next().val();\r\n");
      out.write("\tvar itemTotalPrice = $(this).parent().next();\r\n");
      out.write("\tvar oldTotalPrice = (($(\"#tp\").text()).replace(/[^0-9]/g,'') - (oldAmount*price));\r\n");
      out.write("\t\r\n");
      out.write("\t$.ajax({\r\n");
      out.write("\t\turl : \"");
      out.print(request.getContextPath());
      out.write("/product/productUpdateAmount.do\",\r\n");
      out.write("\t\tdata : \"pId=\"+pId+\"&amount=\"+amount, \r\n");
      out.write("\t\tsuccess : function(data){\r\n");
      out.write("\t\t\t$(this).val(amount);\r\n");
      out.write("\t\t\titemTotalPrice.text(Comma(amount*price)+'원');\r\n");
      out.write("\t\t\t$(\"#tp\").text(Comma(oldTotalPrice + (amount*price))+'원');\r\n");
      out.write("\t\t}\r\n");
      out.write("\t})\r\n");
      out.write("});\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("function Comma(Num) { //function to add commas to textboxes\r\n");
      out.write("    Num += '';\r\n");
      out.write("    Num = Num.replace(',', ''); Num = Num.replace(',', ''); Num = Num.replace(',', '');\r\n");
      out.write("    Num = Num.replace(',', ''); Num = Num.replace(',', ''); Num = Num.replace(',', '');\r\n");
      out.write("    x = Num.split('.');\r\n");
      out.write("    x1 = x[0];\r\n");
      ...
      out.write("}\r\n");
      out.write("\r\n");
      out.write("$(\"#allDelete\").on(\"click\", function(){\r\n");
      out.write("\tif(!confirm(\"정말 삭제하시겠습니까?\")) return;\r\n");
      out.write("\t\r\n");
      out.write("\t$.ajax({\r\n");
      out.write("\t\turl : \"");
      out.print(request.getContextPath());
      out.write("/product/productDeleteAllItem.do\",\r\n");
      out.write("\t\tsuccess : function(data){\r\n");
      out.write("\t\t\tlocation.href=\"");
      out.print(request.getContextPath());
      out.write("/product/productCart\";\r\n");
