 ...
 * Generated at: 2019-01-16 11:11:57 UTC
...
public final class showMyQNAList_jsp extends org.apache.jasper.runtime.HttpJspBase
...
if(memberLoggedIn != null && ("admin").equals(memberLoggedIn.getMemberId())){ 
      ...
      out.write(" \n");
      out.write(" <form >\n");
      out.write("    <table id=\"tbl-qna\" class=\"table table-striped\" style=\"background-color:white;  margin-top: 40px; border-collapse: collapse;\"> \n");
      out.write("      <tr>\n");
 ...
 if(b.getBoardCommentCnt() <= 0){ 
      out.write("\n");
      out.write("\t\t\t<td td style=\"vertical-align:middle; text-align:center;\">미답변</td>\n");
      out.write("\t\t\t");
} else {
      out.write("\n");
      out.write("\t\t\t\t<td td style=\"vertical-align:middle; text-align:center;\">답변완료</td>\n");
      out.write("\t\t\t");
 }
      out.write("\n");
      out.write("\t\t\t<td td style=\"vertical-align:middle; text-align:center;\">");
